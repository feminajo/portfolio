    ...
    <section id="contact" className="section-padding">
      <div className="page-container">
        <SectionHeader
          ...
          description="Open to frontend engineering roles focused on React, TypeScript, and AI-powered products."
        />

        <MotionReveal>
          <motion.div
            className="glass rounded-2xl p-6 sm:p-8 border border-white/[0.08] relative overflow-hidden"
              ...
              <div className="grid sm:grid-cols-3 gap-4 mt-8">
                {contactLinks.map((link) => (
                  <a
                    ...
                    className="glass rounded-lg p-4 border border-white/[0.06] hover:border-indigo-500/20 transition-all group"
                  >
